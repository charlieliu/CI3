...
class Css_test extends CI_Controller {
    ...
    public function __construct()
    {
        ...
        $content[] = [
            'content_title' => 'CSS select',
            'content_url' => 'css_test/css_select',
        ];
    ...
    public function css_select()
    {
        ...
        // 中間挖掉的部分
        $content_div = $this->parser->parse('css_test/css_select_view', $data, true);
        // 中間部分塞入外框
        $html_date = $data ;
        $html_date['content_div'] = $content_div ;
        $html_date['css'][] = 'css/css_select.css' ;
