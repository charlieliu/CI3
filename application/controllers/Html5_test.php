...
class Html5_test extends CI_Controller {
    ...
    public function test($in='1')
    {
        ...
        else
        {
            ...
            if( !empty($in) )
            {
                if(file_exists('js/html5_test/test_'.$in.'.js'))
